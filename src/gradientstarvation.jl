...
# experiments_2 = OrderedDict(
#     "GD Δ0.5 + SD 10000" => Experiment("GD", 0.5, true),
# )
# Experiments.run_experiments(experiments_2, show_plots = false, random_moons = false, epochs = 10000)

# experiments_3 = OrderedDict(
#     "ADAM Δ0.5 + SD" => Experiment("ADAM", 0.5, true),
# )
# Experiments.run_experiments(experiments_3, show_plots = false, random_moons = false, learning_rate = 1e-4, prefix = "1e-4")
# Experiments.run_experiments(experiments_3, show_plots = false, random_moons = false, learning_rate = 1e-3, prefix = "1e-3")
